...
- **P5 Slice A delivered — admin review: inline doc preview + approval-ready inspection (2026-05-27)**
  ...
  - Manual LAN verification on 192.168.3.245 (2026-05-27): PENDING — user to confirm inline embeds, history disclosure, and OCR-readout layout from staff session.
